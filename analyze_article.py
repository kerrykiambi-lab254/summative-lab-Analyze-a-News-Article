...
def analyze():
    ...
    print(f"Specific word 'Apple' count: {count_specific_word(article_text, 'Apple')}")
    print(f"Specific word 'ACME' count: {count_specific_word(article_text, 'ACME')}")
    print(f"Most common word: {identify_most_common_word(article_text)}")
    print(f"Average word length: {calculate_average_word_length(article_text)}")
